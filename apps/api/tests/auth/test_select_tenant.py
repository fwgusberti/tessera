...
class TestSelectTenantRejections:
    ...
    def test_non_member_company_returns_403_not_a_member(self):
        ...
        with (
            ...
            patch("tessera_api.routers.auth.SqlCompanyRepository") as mock_company_cls,
            ...
            mock_company_repo.get_membership = AsyncMock(return_value=None)  # not a member
            mock_company_cls.return_value = mock_company_repo

            mock_rt_repo = AsyncMock()
            mock_rt_cls.return_value = mock_rt_repo

            response = self._post(token, target_company_id)
    ...
    def test_inactive_company_returns_403_company_suspended(self):
        ...
        with (
            ...
            mock_rt_cls.return_value = AsyncMock()
